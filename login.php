...
$_SESSION['rainbow_sucursal']=$res['sucursal_varchar'];
         ...
         <div class="row ">
                ...
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                            ...
                            <div class="panel-body" style="background-color: #E2E2E2; margin-top:50px; border:solid 3px #0e0e0e;">
							  <!--<h3 class="myhead">Sistema de Pago Instituto C.I.T.E</h3>-->
                              <img src="img/LogoLoginCeti.jpeg" style="width: 250px; height: 230px; margin-left: 35px;">
