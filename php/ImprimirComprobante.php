...
if ($imprime==2){
$sql2="SELECT * FROM fees_transaction where sucursal_varchar='$sucursal' and id=$estuId and estado=1 order by submitdate desc LIMIT 1";
...
<html>
<body>
	<h2 style="text-align:center">Comprobante de Ingreso </h2>
	...
	<div style="line-height:4px">	
		...
		<h4>Lugar y Fecha: <label style="font-weight:30"> La Paz, <?php echo $DatosC['submitdate'] ?> </label></h4>
	...
	<table class="table table-striped table-bordered table-hover" id="tSortable22" style="font-size: 16px;width: 100%;">
									...
									echo '<tr>
                                            ...
                                            <td style="text-align:right">'.$DatosC['paid'].'</td>
    ...
    <h3 style="text-align:right">Total Bolivianos:<label style="font-weight: 30; font-size:24px"> <?php echo $DatosC['paid'];?>.-</label> </h3>
    <!-- <h5 >Son:<label style="font-weight: 30; font-size:14px"> <?php
     ...
     <br>
     <label class="col-sm-2 control-label" for="Old" style=" font-size: 11px;">Usuario: <?php echo $_SESSION['rainbow_name']; ?>  --- Nota: No se aceptan devoluciones una vez realizado el pago.   ----- Fecha de Impresión:  <?php echo date("Y-m-d h:i:sa") ?></label>
