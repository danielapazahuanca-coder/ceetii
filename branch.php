...
$detail = mysqli_real_escape_string($conn,$_POST['detail']);
 ...
 if($_POST['action']=="add")
 {
  ...
  $sql = $conn->query("INSERT INTO branch (branch,address,detail,sucursal_varchar) VALUES ('$branch','$address','$detail','$sucursal')") ;
 ...
 $id = mysqli_real_escape_string($conn,$_POST['id']);	
   $sql = $conn->query("UPDATE  branch  SET  branch  = '$branch', address  = '$address', detail  = '$detail'  WHERE  id  = '$id' and sucursal_varchar  = '$sucursal'");
...
$conn->query("UPDATE  branch set delete_status = '1'  WHERE sucursal_varchar='$sucursal' and id='".$_GET['id']."'");
...
$sqlEdit = $conn->query("SELECT * FROM branch WHERE sucursal_varchar='$sucursal' and  id='".$id."'");
if($sqlEdit->num_rows)
{
                        ...
                        <div class="panel-body">
                             <div class="table-sorting table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
                                    ...
                                    <tbody>
									<?php
									$sql = "select * from branch where delete_status='0' and sucursal_varchar='$sucursal'";
									$q = $conn->query($sql);
									$i=1;
