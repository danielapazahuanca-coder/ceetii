...
$sid = (isset($_POST['student']))?mysqli_real_escape_string($conn,$_POST['student']):'';
 ...
 $sql = "select s.idRegistro,s.Cod_Estu,s.sname,s.balance,s.fees,s.contact,b.branch,s.joindate from student as s,branch as b where b.id=s.branch and  s.delete_status='0' and s.sucursal_varchar='".$sucursal."' and s.Cod_Estu='".$sid."'";
$q = $conn->query($sql);
if($q->num_rows>0)
{
...
echo '  <form class="form-horizontal" id ="signupForm1" action="fees.php" method="post">
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" id="nameEstu" name="nameEstu" class="form-control" readonly=false  value="'.$res['sname'].'" >
    </div>
  </div>
  ...
  <!--<div class="form-group">
    <label class="control-label col-sm-2" for="email">Fecha de pago:</label>
    <div class="col-sm-10">
