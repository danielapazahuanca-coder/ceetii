  ...
  <div class="form-group">
    ...
    <select  class="form-control" id="branch" name="branch" >
		<option value="" >Selecciona Banco</option>
                                    <?php
									$sql = "select * from branch where delete_status='0' and sucursal_varchar='$sucursal' order by branch.branch asc";
									$q = $conn->query($sql);
...
function mydatatable()
{
              ...
              $("#subjectresult").html('<table class="table table-striped table-bordered table-hover" id="tSortable22"><thead><tr><th>Name/Contact</th><th>Fees</th><th>Balance</th><th>Curso</th><th>FechaIngreso</th><th>Action</th></tr></thead><tbody></tbody></table>');
